...
class ApiRule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"any",b"any",u"custom",b"custom",u"delete",b"delete",u"get",b"get",u"http_method",b"http_method",u"patch",b"patch",u"post",b"post",u"put",b"put"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"additional_bindings",b"additional_bindings",u"any",b"any",u"body",b"body",u"custom",b"custom",u"delete",b"delete",u"desc",b"desc",u"get",b"get",u"group",b"group",u"http_method",b"http_method",u"not_enable",b"not_enable",u"patch",b"patch",u"post",b"post",u"put",b"put",u"response_body",b"response_body",u"summary",b"summary",u"tag",b"tag"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"http_method",b"http_method"]) -> typing.Optional[typing_extensions.Literal["get","put","post","delete","patch","custom","any"]]: ...
...
class CustomHttpPattern(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"kind",b"kind",u"path",b"path"]) -> builtins.bool: ...
...
class Tag(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"desc",b"desc",u"name",b"name"]) -> None: ...
global___Tag = Tag
...
class HttpMethod(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"default",b"default",u"http_url",b"http_url",u"url",b"url"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"default",b"default",u"http_url",b"http_url",u"url",b"url"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"http_url",b"http_url"]) -> typing.Optional[typing_extensions.Literal["url","default"]]: ...
