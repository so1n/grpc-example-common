...
class LikeBookRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["isbn", b"isbn", "like", b"like", "uid", b"uid"]
    ) -> None: ...
...
class GetBookLikesListResult(google.protobuf.message.Message):
    ...
    def result(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___GetBookLikesResult]: ...
    def __init__(
        self,
        *,
...
class CommentBookRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["content", b"content", "isbn", b"isbn", "uid", b"uid"]
    ) -> None: ...
...
class GetBookCommentResult(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "content", b"content", "create_time", b"create_time", "isbn", b"isbn", "uid", b"uid"
        ],
    ) -> None: ...
...
class GetBookCommentListResult(google.protobuf.message.Message):
    ...
    def result(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___GetBookCommentResult]: ...
    def __init__(
        self,
        *,
